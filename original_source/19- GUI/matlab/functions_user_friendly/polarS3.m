function hpol = polarS3(varargin)
...
% check radial limits and ticks
    ...
    rmin = 0; rmax = 1; rticks = max(ticks-1,2);
...
if strcmp(line_style,'auto')
    ...
    q = plot(xx,yy,'color',line_style,'parent',cax);
end
...
set(get(cax,'xlabel'),'visible','off')
set(get(cax,'ylabel'),'visible','off')
