function [appdata] = make_retina_app(app, appdata,show_fig)
...
function show_RGC_distribution_app(RetONx,RetONy,RetOFFx,RetOFFy,rf_space_x, app)
    % Plotting ON OFF RGCs on Retinotopy map
%         axis_lim = size(rf_space_x,1);
%         MarkerSize = 20;
