function [appdata] = generate_rf_cortex_primord_app_sn(appdata)
    ...
    [rf_primord_contra,data_primord_contra] = generate_rf_cortex_primordial_initial_gui('contra',RetinaRF,r_covered_aff,rowRange,colRange,ODCrtxPlt,ONOFF_smoothed_binary, ... 
    ...
    [rf_primord_ipsi,data_primord_ipsi] = generate_rf_cortex_primordial_initial_gui('ipsi',RetinaRF,r_covered_aff,rowRange,colRange,ODCrtxPlt,ONOFF_smoothed_binary, ... 
    RetONOFFsorted,rAffSpread,IndRetinaRfspace,weight_map_island,ODCrtxPlt_smooth,pix2deg,sf_lSamp,n_ori_smooth,sigma_LHI_2d,debug,show_fig);
