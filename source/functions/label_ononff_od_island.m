function [ONOFFODLabelSorted,CenterPinwheelSorted,NumPinwheel,CenterPWImage] = label_ononff_od_island(ODCrtxPlt,ONOFFCrtxPlt,debug, show_fig)
    ...
    for bb = 1 : NumPinwheel
        iPw = indPinwheelSorted(bb); 
        ONOFFODLabelSorted = ONOFFODLabelSorted + (ONOFFODLabel == iPw) .* bb;
        CenterPinwheelSorted{bb} =  FeatureCenter{iPw};
    end
